# modified conda.fish file to stop displaying a left-prompt if on the base conda enve
# still displays a thing if in a new cond env
# put: /home/turner/tools/anaconda3/pkgs/conda-4.7.12-py37_0/lib/python3.7/site-packages/conda/shell/etc/fish/conf.d/
