...
if status --is-interactive
	...
	eval /home/turner/tools/anaconda3/bin/conda "shell.fish" "hook" $argv | source
	# <<< conda initialize <<<
	...
	function fish_greeting
	    ...
	    if test $tt -lt 12
	        ...
	        # echo "good morning jordan  | " (date "+%F %H:%M:%S")
...
# synphot database directory
set -xg PYSYN_CDBS /home/turner/tools/synphot/cdbs